            ...
            if (player1Turn) {
                ...
                try {
                    ...
                    if (choiceStr == null || choiceStr.trim().isEmpty()) {
                        System.out.println("[PK系统] 玩家1 (" + player1Name + ") 输入为空，继续等待");
                        out1.println("输入为空，请重新输入 11 或 12");
                        continue;
                    }
                ...
                try {
                    ...
                    System.out.println("[PK系统] 玩家2 (" + player2Name + ") 收到输入: " + (choiceStr != null ? choiceStr : "null"));
                    
                    // 检查输入是否为null
                    if (choiceStr == null || choiceStr.trim().isEmpty()) {
                        System.out.println("[PK系统] 玩家2 (" + player2Name + ") 输入为空，继续等待");
                        out2.println("输入为空，请重新输入 11 或 12");
                        continue;
                    }
